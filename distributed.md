...
### Pay for the good headphone

Whether your employees work from a home office, a co-working space, or a coffee shop, you want them to be able to focus on their work without noisy distractions. We recommend authorizing your employees to purchase high-end noise-cancelling headphones and establishing a dedicated headphone budget for each employee. 
...
It may seem counterintuitive or strange  to pay for things like café visits or fancy headphones, but this investment in effectiveness pays substantial dividends, not just for Truss but for many other companies. You are not alone.  In fact, before adopting this approach, we did our homework and found that other distributed companies had similar mechanisms.   In particular, we were influenced by [GitLab’s spending company money policy](https://about.gitlab.com/handbook/spending-company-money/), which we encourage you to review.
...
Moreover, following a distributed model means that Truss can hire anyone, anywhere, so long as they have a strong internet connection. This has provided a key recruiting advantage, as many Trussels could not work for us if we required them to be physically present in our San Francisco office (or any other office).   So, the bottom line is better employees for less money.  Not too shabby.
...
As a policy, Truss keeps a sustainable pace of work. We want our employees to maintain their health and sanity after a surge.  To enable this, we ask employees to take time off to recover (known as surge time). If employees work more than 40 hours in a week — be it due to client-related travel, long days, or tight deadlines — we ask employees to let their managers know about the overage and ask for surge time. It’s each employee’s responsibility to determine how much surge time they need to fully recover, and we trust that employees won’t abuse this policy (to date, they haven’t). Because the primary intent of surge time is to help employees maintain a healthy attitude and work-life balance, we do not allow surge days to be used as floating holidays. 
...
Have fun with it! The BHT call is a way to reflect and strengthen your own culture and values. Create a space for one of your team members to come up with a unique and creative expression that enhances the connections in your company.
...
Our colleagues and coffee practice helps people to get to know teammates that they might otherwise not interact with, fostering a greater sense of cross-team connectedness. (Note: We use [https://www.donut.ai](https://www.donut.ai) to schedule the meetings and make the random assignments and Zoom to video conference.) This practice is applicable to groups over 30 and highly recommended for groups of 50 or more.

### Celebrations channel

We have a bot to remind us of folks’ birthdays and Trusselversaries. It also gets the gif party started. Team members opt in to have [https://birthdaybot.io](https://birthdaybot.io) remind others of their birthdays or join dates in a stand-alone channel to keep distractions contained.
...
Although this meeting isn't required, it’s extremely useful with new teams (so folks get used to how to report progress and catch missed expectations early) and in crisis scenarios (when the lay of the land is constantly changing and a weekly check-in cadence isn't viable). This can be asynchronous where folks share their progress and blockers via chat, typically at a pre-appointed time. 
...
* Identify your requirements and blockers. What needs to happen to realize your outcome?  Are any of the people at your meeting blocking this from happening?
...
We use a password manager to ensure that we use strong, unique passwords for all of our tools. We went with 1Password, but there are other competitors. You sincerely should consider adopting one and deploying it to every single device, including laptops and phones and tablets.  
...
We use Code42’s CrashPlan to back up our computers. It runs in the background and incrementally backs up files to cloud storage. Installation requires some manual configuration, but we can recover full images quickly.  This is worth the effort.

## Team chat apps

### Why chat instead of emai

We value security. We also value open and transparent communication. Team chat apps are superior to email in every way by these standards.  Specifically, team chat apps are walled gardens where you control who has an account, and thus can speak to your employees, and who does not.  This eliminates risks of viruses, malware, spam and phishing that is prevalent across email.  Also, as explained below, channels allow anyone discussions to be held in public and semi-public forums that eliminate the spamminess of reply-all chains.  
...
1. It’s OK to mute channels.
1. It’s OK to leave channels. This should not be taken personally. Pop back in if you want to see what’s going on.
1. It’s fine to join a channel to ask a question about that topic — #accounting or #bizops, for example — and leave once you get your answer.
1. You aren’t required to always be available on chat.
1. We use a default Do Not Disturb schedule, but you can set one that works better for you.
1. Nobody is required to immediately respond to every message, especially outside of normal working hours. Keep this in mind both when you ping someone else and when you are pinged. 
1. We consider it a best practice to respond to DMs by the end of the workday.
1. Slack is not the best channel for emergency communications. Use the phone or texting when it’s critical to get a hold of someone.
1. Some of us use multiple Slack workspaces (Truss, client, etc). You can turn off unread notifications for the Truss workspace if that helps you focus on client work.If you’re sharing a message of high importance, disseminate it across multiple channels. This way, everyone on the team can stay on the same page.
...
When you're in a meeting, these tips help:
